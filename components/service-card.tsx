    ...
    <article className="surface-card flex h-[26rem] min-w-0 flex-col overflow-hidden rounded-4xl p-5 shadow-card">
      <div className="flex min-w-0 items-start justify-between gap-3">
        <div className="min-w-0">
          ...
          <h3 className="mt-2 break-words text-xl font-semibold leading-tight">
            {service.name}
          </h3>
          <p className="text-theme-soft mt-3 break-words text-sm leading-6">
      ...
      <div className="mt-4 flex min-w-0 flex-wrap gap-2 text-xs">
        ...
        {service.sourceName ? (
          <span
            className="surface-subtle text-theme-subtle max-w-full truncate rounded-full px-3 py-1.5"
      ...
      <div className="text-theme-subtle mt-4 grid gap-2 text-sm">
        {service.hoursText ? (
      ...
      <div className="mt-auto pt-5">
        <div className="flex items-end justify-between gap-4">
          ...
          <div
            className="text-theme-subtle grid h-11 w-11 shrink-0 place-items-center rounded-2xl"
            aria-hidden="true"
